 ...
 */
package com.mydataway.processors.custom.processors;
...
import com.mydataway.processors.custom.event.BeginTransactionEventInfo;
import com.mydataway.processors.custom.event.BinlogEventInfo;
import com.mydataway.processors.custom.event.BinlogEventListener;
import com.mydataway.processors.custom.event.BinlogLifecycleListener;
import com.mydataway.processors.custom.event.CommitTransactionEventInfo;
import com.mydataway.processors.custom.event.DDLEventInfo;
import com.mydataway.processors.custom.event.DeleteRowsEventInfo;
import com.mydataway.processors.custom.event.InsertRowsEventInfo;
import com.mydataway.processors.custom.event.RawBinlogEvent;
import com.mydataway.processors.custom.event.UpdateRowsEventInfo;
import com.mydataway.processors.custom.event.io.BeginTransactionEventWriter;
import com.mydataway.processors.custom.event.io.CommitTransactionEventWriter;
import com.mydataway.processors.custom.event.io.DDLEventWriter;
import com.mydataway.processors.custom.event.io.DeleteRowsWriter;
import com.mydataway.processors.custom.event.io.InsertRowsWriter;
import com.mydataway.processors.custom.event.io.UpdateRowsWriter;
import com.mydataway.processors.custom.processors.ssl.BinaryLogSSLSocketFactory;
...
public class CaptureChangeMySQL extends AbstractSessionFactoryProcessor {
    ...
    protected void connect(List<InetSocketAddress> hosts, String username, String password, Long serverId, boolean createEnrichmentConnection,
        ...
        while (connectedHost == null && connectionAttempts < numHosts) {
            ...
            //to filter event type start
//            binlogClient.setEventDeserializer();
